...
goog.provide('whodag.chess.ChessBoard')
...
whodag.chess.ChessBoard = function(containerElOrId, cfg) {
'use strict';
...
var CSS = {
  ...
  square: 'square-55d63',
  white: 'white-1e1d7',
  greyWhiteSquare: 'grey-white-square-873d3',
  greyBlackSquare: 'grey-black-square-874ab',
  greyBorderSquare: 'grey-border-square-89248'
};
...
function greySquare(square) {
  var sqr = boardEl.find('.square-' + square);
  if (sqr.hasClass(CSS.black)) {
    sqr.addClass(CSS.greyBlackSquare);
  } else {
    sqr.addClass(CSS.greyWhiteSquare);
  }
}

function removeGreySquares() {
  boardEl.find('.' + CSS.greyBlackSquare).removeClass(CSS.greyBlackSquare);
  boardEl.find('.' + CSS.greyWhiteSquare).removeClass(CSS.greyWhiteSquare);
}

function greyBorderSquare(square) {
  var sqr = boardEl.find('.square-' + square);
  sqr.addClass(CSS.greyBorderSquare);
}

function removeGreyBorderSquares() {
  boardEl.find('.' + CSS.greyBorderSquare).removeClass(CSS.greyBorderSquare);
}
...
widget.isGreySquare = function(square) {
  var sqr = boardEl.find('.square-' + square);
  return sqr.hasClass(CSS.greyBlackSquare) || sqr.hasClass(CSS.greyWhiteSquare);
};

widget.greySquare = function(square) {
  greySquare(square);
};
...
widget.isGreyBorderSquare = function(square) {
  return boardEl.find('.square-' + square).hasClass(CSS.greyBorderSquare);
};

widget.greyBorderSquare = function(square) {
  greyBorderSquare(square);
};

widget.removeGreyBorderSquares = function() {
  removeGreyBorderSquares();
};
...
function mousedownSquare(e) {
  ...
  if ((cfg.hasOwnProperty('onMousedownSquare') === true) &&
      (typeof cfg.onMousedownSquare === 'function')) {
    ...
    cfg.onMousedownSquare(square, piece, deepCopy(CURRENT_POSITION), CURRENT_ORIENTATION)
  }
...
whodag.chess.ChessBoard.fenToObj = fenToObj;
whodag.chess.ChessBoard.objToFen = objToFen;
